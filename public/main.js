  ...
  async function makeSpots(data) {
    ...
    for (var spot in data) {
      ...
      if (dat.x == 0 && dat.y == 0) {
        ...
        spot = spot;
        htmlDat += `<div class="spot tooltip"style="top:${dat.y}px; left:${dat.x
    ...
    dt += sp
      .map(
        d =>
          `
<div class="sdata">
<span style="font-size: 20px;color:var(--col-cyan); padding-top: 4px; padding-bottom: 4px;">#${d.MonsterID
          } ${d.Pokemon}</span>
<br>
<b>Daytime</b> - ${daytime(d.Daytime)}, 
<b>Level Range</b> - ${d.MinLVL} to ${d.MaxLVL}, <b>Tier</b> - ${d.Tier
          }, <b>Item</b> - ${d.Item || "None"}, <b>MS</b>: ${d.MemberOnly == true ? "Yes" : "No"
